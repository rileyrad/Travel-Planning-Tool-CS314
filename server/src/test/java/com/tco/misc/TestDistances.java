...
public class TestDistances {
    ...
    @BeforeEach
    public void setup() {
        testLocations = Arrays.asList(new Geo(-90, 0), new Geo(-90, -180), new Geo(90, 0), new Geo(90, 180),
                new Geo(25.314, 25.314));
        expectedDistances = Arrays.asList(0L, 20037L, 0L, 20037L, 7200L);
        earthRadius = 6378.14;
